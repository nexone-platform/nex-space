...
const EN: Record<string, string> = {
  ...
  "เอกสารอยู่ที่เดิมของมัน — NexSpace เก็บแค่ชื่อกับทางเข้าถึง ไม่ได้คัดลอกไฟล์มา":
    "The documents stay where they are — NexSpace keeps the name and the way in, not a copy",
  "กำลังเปิด…": "Opening…",
  "ตู้นี้ไม่ได้เปิดให้คุณ": "This cabinet is not open to you",
  ...
  "นำออก": "Take out",
  "นำออกไม่สำเร็จ": "Could not take it out",
  "ชื่อตู้": "Cabinet name",
  "เปลี่ยนชื่อไม่สำเร็จ": "Could not rename it",
  "ใครเปิดตู้นี้ได้": "Who may open this cabinet",
  "ใครเปิดเอกสารนี้ได้ — {name}": "Who may open this document — {name}",
  "รายชื่อที่เปิดตู้ได้": "Access list",
  "ทุกคนในทีม": "Everyone in the space",
  "เฉพาะคนที่ระบุชื่อ": "Only the names listed",
  "เปิดให้ทุกคนในทีม": "Open to everyone in the space",
  "ตามการตั้งค่าของตู้": "Follow the cabinet",
  "ตามค่าเริ่มต้น": "Default",
  "เปิดอ่านได้": "May read",
  "อ่านและเพิ่มเอกสารได้": "May read and file",
  "ไม่ให้เข้าถึง": "No access",
  "ดูแล Space — เห็นทุกอย่างเสมอ": "Runs the space — always sees everything",
  "เปลี่ยนไม่สำเร็จ": "Could not change it",
  "บันทึกสิทธิ์": "Save access",
  "บันทึกสิทธิ์ไม่สำเร็จ": "Could not save the access list",
  "เอกสารนี้": "This document",
  "ชื่อเอกสาร": "Document name",
  "วางลิงก์ Google Drive หรือ OneDrive": "Paste a Google Drive or OneDrive link",
  "เลือกจาก Google Drive": "Choose from Google Drive",
  "กำลังเปิด Google Drive…": "Opening Google Drive…",
  "เปิด Google Drive ไม่ได้ — วางลิงก์แทนได้": "Could not open Google Drive — paste a link instead",
  "เพิ่มเข้าตู้": "File it",
  "ใส่ชื่อและลิงก์ของเอกสาร": "A document needs a name and a link",
  "เพิ่มเอกสารไม่สำเร็จ": "Could not file it",
  "เพิ่มแล้ว": "Filed",
  "ลิงก์": "Link",
  "สิทธิ์เข้าถึง": "Access",
  "คุณดูแล Space นี้": "you run this space",
  "คุณถูกระบุชื่อบนเอกสารนี้": "you are named on this document",
  "เอกสารนี้เปิดให้ทุกคนในทีม": "this document is open to the space",
  "คุณถูกระบุชื่อบนตู้นี้": "you are named on this cabinet",
  "ตู้นี้เปิดให้ทุกคนในทีม": "this cabinet is open to the space",
  "สว่าง": "Light",
  "มืด": "Dark",
  ...
  "เชื่อมปฏิทิน {what} ของฉัน": "Connect my {what}",
  "เขียนลงปฏิทิน {what} ของ {email} แล้ว": "Writing into the {what} of {email}",
  "เลิกเขียนการจองลงปฏิทิน {what} ของคุณ?": "Stop writing bookings into your {what}?",
  "ครั้งล่าสุด {what} ไม่รับ — ลองเชื่อมใหม่": "{what} refused the last write — try connecting again",
  "เชื่อมปฏิทิน {what} แล้ว": "{what} connected",
  "เชื่อมปฏิทิน {what} ไม่สำเร็จ": "Could not connect {what}",
  "{what} ไม่ได้ให้สิทธิ์ค้างไว้ — ลองใหม่และกดอนุญาต": "{what} did not grant lasting access — try again and allow it",
  ...
  "ได้เฉพาะส่วนของคุณ": "Your own part of it",
  ...
  "ผู้เข้าร่วม": "Guests",
  "แขกจากภายนอก": "Guests from outside",
  "อีเมลสมาชิกในพื้นที่นี้": "Email of somebody in this space",
  "อีเมลคนนอก": "Email address",
  "เอาออก": "Remove",
  "ภายนอก": "outside",
  "ไม่ไป": "Not coming",
  "อาจจะไป": "Maybe",
  ...
  "ทำซ้ำได้เฉพาะอีเมล": "Only an email can repeat",
  ...
  "เวลาสิ้นสุดต้องอยู่หลังเวลาเริ่ม": "It has to end after it starts",
  "การประชุมต้องยาวอย่างน้อย {n} นาที": "A booking is at least {n} minutes",
  "การประชุมต้องยาวไม่เกิน {n} ชั่วโมง": "A booking is at most {n} hours",
  "เวลานั้นผ่านไปแล้ว เลือกเวลาข้างหน้า": "That time has already passed — pick a later one",
  "จองล่วงหน้าได้ไม่เกิน {n} วัน": "You can book up to {n} days ahead",
  ...
  "คำเชิญนี้ถูกยกเลิกแล้ว": "This invitation was cancelled",
  "คำเชิญนี้หมดอายุแล้ว — ขอลิงก์ใหม่จากผู้เชิญ": "This invitation has expired — ask whoever invited you for a new link",
  "ใช้คำเชิญนี้ไม่ได้": "That invitation cannot be used",
  "อีเมลของคนที่จะเชิญ": "Their email address",
  "ส่งคำเชิญ": "Send invitation",
  "ใส่อีเมลก่อน": "Enter an email address first",
  "คนนี้อยู่ในพื้นที่นี้แล้ว": "They are already in this space",
  "ส่งคำเชิญไม่สำเร็จ": "The invitation did not go",
  "ส่งคำเชิญไปที่ {email} แล้ว": "Invitation sent to {email}",
  "สร้างคำเชิญแล้ว แต่ยังส่งอีเมลไม่ได้ — คัดลอกลิงก์ส่งให้เอง": "Invitation made, but the email could not be sent — copy the link and pass it on",
  "เฉพาะเจ้าของและผู้ดูแลที่ดูคำเชิญได้": "Only the owner and admins can see invitations",
  "ยังไม่มีคำเชิญ — ใส่อีเมลด้านบนเพื่อเชิญคนเข้าทีม": "No invitations yet — put an address above to invite somebody",
  "โดย {name}": "by {name}",
  "อีเมลยังไม่ได้ส่ง": "email not sent",
  "คัดลอกลิงก์": "Copy link",
  "ยกเลิกคำเชิญ": "Cancel this invitation",
  "ยกเลิกคำเชิญที่ส่งไป {email}?": "Cancel the invitation to {email}?",
  "ยกเลิกคำเชิญแล้ว": "Invitation cancelled",
  "รอตอบรับ": "Pending",
  "เข้าร่วมแล้ว": "Joined",
  "หมดอายุ": "Expired",
  "คำเชิญ": "Invitations",
  ...
  "＋ จองห้อง": "＋ Book a room",
  "ปิดฟอร์ม": "Close",
  "ประชุมเรื่องอะไร": "What is the meeting about?",
  "จอง": "Book",
  "จองห้องนี้": "Book this room",
  "หัวข้อ": "Title",
  "ห้อง": "Room",
  "เริ่ม": "From",
  "ถึง": "To",
  "แผนที่นี้ยังไม่มีห้องให้จอง": "This map has no rooms to book",
  "ตั้งชื่อการประชุมก่อน": "Give the meeting a name first",
  "เลือกห้องก่อน": "Pick a room first",
  "ห้องไม่ว่าง — {title} {from}–{to}": "That room is taken — {title} {from}–{to}",
  "ห้องไม่ว่างช่วงนั้น": "That room is taken then",
  "จองไม่สำเร็จ": "The booking did not go through",
  "จองแล้ว": "Booked",
  "ยังไม่มีใครจองห้องวันนี้": "No rooms booked",
  "มา {n} คน": "{n} going",
  "จะไป ✓": "Going ✓",
  "จะไป": "Going",
  "กดเพื่อบอกว่าไม่ไปแล้ว": "Tap to say you are not going after all",
  "บอกว่าจะไป — จะได้รับการเตือนก่อนเริ่ม": "Say you are going — you will be reminded before it starts",
  "ยกเลิกการจอง": "Cancel this booking",
  "ยกเลิก {title}?": "Cancel {title}?",
  ...
  "คัดลอกแล้ว ✓": "Copied ✓",
  "ใครมีที่อยู่นี้ก็อ่านปฏิทินได้ — เปลี่ยนใหม่ได้ในหน้าตั้งค่า": "Anyone with this address can read the calendar — you can change it in settings",
  "{title} เริ่มในอีก {n} นาที": "{title} starts in {n} min",
  "{title} เริ่มแล้ว": "{title} is starting",

  // ---- files in the chat ----
  "แนบไฟล์": "Attach a file",
  "เอาไฟล์ออก": "Remove the file",
  "กำลังส่ง…": "Sending…",
  "ไฟล์ใหญ่เกินไป — สูงสุด {n}": "That file is too large — {n} at most",
  "ส่งไฟล์ชนิดนี้ไม่ได้": "That kind of file is not accepted",
  "ไม่มีสิทธิ์ส่งไฟล์ในพื้นที่นี้": "You cannot send files in this space",
  "ส่งไฟล์ไม่สำเร็จ — ลองอีกครั้ง": "The file did not go — try again",
