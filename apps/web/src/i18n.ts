...
const EN: Record<string, string> = {
  ...
  "ทักกลับได้จากรายชื่อคน": "Wave back from the people list",
  ...
  "{name} เรียกให้ไปหา — เปิดกระดิ่งเพื่อไป": "{name} would like you to come over — open the bell to go",
  "กดเพื่อไปที่นั่น": "Tap to go there",
  ...
  "แชร์ลิงก์นี้ให้เพื่อนร่วมงาน": "Share this link with your colleagues",
