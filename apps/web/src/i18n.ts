...
const EN: Record<string, string> = {
  ...
  "สร้างโฟลเดอร์แล้ว": "Folder made",
  "สร้างโฟลเดอร์ไม่สำเร็จ": "Could not make the folder",
  "โฟลเดอร์ต้องมีชื่อ": "A folder needs a name",
  "โฟลเดอร์นี้ว่าง": "This folder is empty",
  "โฟลเดอร์นี้": "This folder",
  "ไม่อยู่ในโฟลเดอร์": "Not in a folder",
  "ลบโฟลเดอร์": "Delete folder",
  "ลบโฟลเดอร์ไม่สำเร็จ": "Could not delete the folder",
  "ลบโฟลเดอร์แล้ว — เอกสาร {n} รายการกลับไปอยู่ในตู้":
    "Folder deleted — {n} document(s) went back into the cabinet",
  "{n} รายการ": "{n} item(s)",
  "ใครเปิดโฟลเดอร์นี้ได้ — {name}": "Who may open this folder — {name}",
  "คุณถูกระบุชื่อบนโฟลเดอร์นี้": "you are named on this folder",
  "โฟลเดอร์นี้เปิดให้ทุกคนในทีม": "this folder is open to the space",
  "นำออก": "Take out",
